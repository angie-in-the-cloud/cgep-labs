...
- `scripts/` - shared utilities (evidence capture, policy gate, etc.)
...
- Lab 3.4: Integrating PaC with Terraform via Conftest (AWS variants of SC-28/AC-3/CM-6 + fail-closed gate)